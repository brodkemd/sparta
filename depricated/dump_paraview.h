...
#ifndef SPARTA_DUMP_PARAVIEW_H
#define SPARTA_DUMP_PARAVIEW_H

#include "dump.h"

namespace SPARTA_NS {
    class DumpParaview : public Dump {
        public:
            DumpParaview(class SPARTA *, int, char **);
            ~DumpParaview();
        ...
        private:
            ...
            typedef void (DumpParaview::*FnPtrHeader)(bigint);
            FnPtrHeader header_choice;           // ptr to write header functions
            void header_binary(bigint);
            void header_item(bigint);

            typedef void (DumpParaview::*FnPtrData)(int, double *);
            ...
            typedef void (DumpParaview::*FnPtrPack)(int);
            FnPtrPack *pack_func;              // ptrs to pack functions
